...
--
-- Table structure for table `despesasempresa`
--

DROP TABLE IF EXISTS `despesasempresa`;
...
--
-- Dumping data for table `despesasempresa`
--

LOCK TABLES `despesasempresa` WRITE;
/*!40000 ALTER TABLE `despesasempresa` DISABLE KEYS */;
/*!40000 ALTER TABLE `despesasempresa` ENABLE KEYS */;
UNLOCK TABLES;
