...
CREATE TABLE `empresa` (
  ...
  `precoVendido` decimal(10,2) DEFAULT NULL,
  `custoVendido` decimal(10,2) DEFAULT NULL,
  `dataVendido` datetime DEFAULT CURRENT_TIMESTAMP,
  `produto` int DEFAULT NULL,
  PRIMARY KEY (`id_empresa`),
  KEY `produto` (`produto`),
  CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`produto`) REFERENCES `produto` (`id_produto`)
