                            ...
                            <div class="product-options">
                                <c:choose>
                                    <c:when test="${idCategoria == 1}">
                                        ...
                                        <label>
                                            Massa
                                            <select name="massa" id="massa" class="input-select">
                                                <c:forEach items="${massas}" var="m">
                                                    <option value="${m.idMassa}">${m.nome} <span>+${m.valorAdicional}</span></option>
                                                </c:forEach>
                                            </select>
                                        </label>
                                        <label>
                                            Recheio
                                            <select name="recheio" id="recheio" class="input-select">
                                                <c:forEach items="${recheios}" var="r">
                                                    <option value="${r.idRecheio}">${r.nome} <span>+${r.valorAdicional}</span></option>
                                                </c:forEach>
                                            </select>
                                        </label>
                                        <label>
                                            Cobertura
                                            <select name="cobertura" id="cobertura" class="input-select">
                                                <c:forEach items="${coberturas}" var="c">
                                                    <option value="${c.idCobertura}">${c.nome} <span>+${c.valorAdicional}</span></option>
                                                </c:forEach>
                                            </select>
                                        </label>
                                        <label>
                                            Topper
                                            <select name="topper" id="topper" class="input-select">
                                                <c:forEach items="${toppers}" var="t">
                                                    <option value="${t.idTopper}">${t.nome} <span>+${t.valorAdicional}</span></option>
                                                </c:forEach>
                                            </select>
                                        </label>
                                        <div class="qty-label">
                                            ...
                                            <div class="input-number">
                                                <input type="number" id="qtd" name="qtd" step="0.5" min="0" value="1">
                                                <div class="qty-up">+</div>
                                                <div class="qty-down">-</div>
                                            </div>
                                        </div>
                                    </c:when>
                                    <c:when test="${idCategoria == 2 || idCategoria == 3}">
                                        <!-- Quando categoria = 2 ou 3 -->
                                        <label>
                                            Sabores
                                            <div id="sabores">
                                                <c:forEach items="${sabores}" var="s">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="sabor" value="${s.idSabor}" data-nome="${s.nome}" data-valor="${s.valorAdicional}" onchange="updateSelectedFlavors()">
                                                            ${s.nome} <span>+${s.valorAdicional}</span>
                                                        </label>
                                                    </div>
                                                </c:forEach>
                                            </div>
                                    ...
                                    <c:otherwise>
                                        <!-- Conteúdo padrão ou mensagem de erro -->
